# This is basically Pokemon Essentials pbPokemonScreen code.
# I'm copying it again to override whatever some plugins do.
...
# This adds relearning from the party screen. This isn't an Essentials feature but it is a Vanguard feature, so should be in the base core mod.
MenuHandlers.add(:party_menu, :relearn, {
  "name" => _INTL("Relearn"),
  "order" => 60,
  "condition" => proc { |screen, party, party_idx| next !party[party_idx].egg? },
  "effect" => proc { |screen, party, party_idx|
    if MoveRelearnerScreen.pbGetRelearnableMoves(party[party_idx]).empty?
